...
const About = () => {
  return (
    <>
      ...
      >
        I'm a skilled DevOps Engineer with experience in DevOps Technology and
        AWS Cloud, and expertise in tools like Docker, K8s, Jenkins, Ansible, Terraform,
        Prometheus, Grafana, Git, GitHub, Python, Shell Scripting, and
